...
void AdminController::createAdmin(const QString &username, const QString &password, const QString &firstName, const QString &lastName) {
    ...
    networkManager->createAdditionalAdmin(username, password, firstName, lastName);
}
